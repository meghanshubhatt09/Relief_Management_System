 ...
 * @author rk
 */
public class CommunitySetUpInformation extends javax.swing.JPanel {
    ...
    public CommunitySetUpInformation(JPanel userProcessContainer, OrganizationDirectory organizationDirectory, Enterprise enterprise, EcoSystem ecoSystem, UserAccount userAccount) {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("".equals(jOrgName.getText())) {
            ...
            enterprise.getOrganizationDirectory().createOrganization(Organization.Type.Community, jOrgName.getText(), locationPoint);
            resetFields();
